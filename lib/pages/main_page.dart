...
class _HomeDashboardState extends State<HomeDashboard>
{
          ...
          children: [
            ListTile (
              ...
              onTap: () async
              {
                ...
                final result = await BillAiService().uploadAndProcessBill(source: ImageSource.camera,);
            ...
            ListTile(
              ...
              onTap: () async
              {
                ...
                final result = await BillAiService().uploadAndProcessBill(source: ImageSource.gallery,);
  ...
  Widget _buildContent()
  {
    ...
    return Column(
      ...
      children: [
        ...
        // Bills with a due date less than 3 days away will be displayed on the screen.
  ...
  //main function to display items on screen
  @override
  Widget build(BuildContext context)
  {
    return Scaffold(
      appBar: AppBar(title: const Text("Finans Dashboard")),
